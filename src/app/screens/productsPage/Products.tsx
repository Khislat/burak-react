					...
					<Stack className={"dishes-filter-section"}>
						<Stack className="dishes-filter-box">
							<Button
								...
								onClick={() => searchOrderHandlear("createdAt")}>
								New
							</Button>
							<Button
								variant="contained"
								...
								onClick={() => searchOrderHandlear("productPrice")}>
								Price
							</Button>
							<Button
								variant="contained"
								...
								onClick={() => searchOrderHandlear("productViews")}>
								Views
							</Button>
						</Stack>
					</Stack>
								...
								products.map((product: Product) => {
									...
									return (
										<Stack
											...
											onClick={() => chooseDishHandlear(product._id)}>
											<Stack
